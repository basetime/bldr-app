...
| --cb -f:shared | Shared Content Builder Folders |
| --cb -a:shared | Shared Content Builder Assets  |
...
| --de -f:shared | Shared Data Extension Folders  |
| --de -a:shared | Shared Data Extension Assets   |
