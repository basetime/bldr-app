...
2. Files
   ...
   2. .sfmc.env.json [optional with environment variables => Y]
   3. template.sfmc.env.json [optional with environment variables => Y]
   4. .gitignore [optional with environment variables => Y]


*If you do not see `.local.manifest.json, .sfmc.env.json, .gitignore` after running the command* <br />
**On Mac:** Open Finder, press `Command + Shift + .(period)` <br/>
...
For full Environment Variable details, see <Link href="/documentation/sfmc/v1/environment-variables/"><a>Environment Variables</a></Link>
