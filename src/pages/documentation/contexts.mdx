...
BLDR defines SFMC Contexts as the _builders/studios_ or _objects/assets_ within SFMC. The processing and BLDR support may vary based on each specific context. In regard to BLDR commands, _search_ and _clone_ require a context flag to be used.
